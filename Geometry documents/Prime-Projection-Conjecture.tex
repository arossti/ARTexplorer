...
\textbf{Breakthrough findings (v3.0, Feb 2026):}
\begin{itemize}
    \item \textbf{5-gon and 7-gon}: Truncated tetrahedron at rational spreads $(0, 0, \frac{1}{2})$ and $(0.11, 0, \frac{1}{2})$
    \item \textbf{11-gon}: Compound of truncated tetrahedron + icosahedron at spreads $(0, 0.4, 0.2)$
    \item \textbf{13-gon}: Same compound at spreads $(0, 0.6, 0.8)$
\end{itemize}
...
\midrule
\textbf{11-gon} & $(0, 0.4, 0.2)$ & 11 & Quintic polynomial (degree 5) \\
\textbf{13-gon} & $(0, 0.6, 0.8)$ & 13 & Sextic polynomial (degree 6) \\
\bottomrule
\end{tabular}
\end{center}
...
ARTexplorer/
|-- scripts/
|   |-- prime_projection_search.py    # Main search script (Python 3.9+)
|   |-- requirements.txt              # NumPy, SciPy dependencies
|
|-- results/
|   |-- prime_breakthrough_20260206_145052.json      # Verified 5,7,11,13-gon findings
|   |-- prime_projections_20260206_122523.json       # Full search data (~27MB)
|   |-- prime_compound_11gon_20260206_144804.json    # 11-gon detailed analysis
|
|-- Geometry documents/
|   |-- Prime-Projection-Conjecture.tex   # This whitepaper
|   |-- Polygon-Rationalize.md            # Quickstart guide for agents
|   |-- Logs.md                           # Working notes and debug output
|
|-- modules/
|   |-- rt-math.js                        # Rational Trig core (RT.PureCubics, etc.)
|   |-- rt-polyhedra.js                   # Polyhedra generation
|   |-- rt-papercut.js                    # Projection overlay visualization
\end{lstlisting}
...
# Quick verification of known primes
python scripts/prime_projection_search.py \
    --precision 2 \
    --polyhedra truncated_tetrahedron \
    --primes 5,7

# Full compound search for 11,13-gon (takes ~10 minutes)
python scripts/prime_projection_search.py \
    --precision 2 \
    --include-compounds \
    --primes 7,11,13
...
\begin{tabular}{cllcl}
\toprule
\textbf{Prime} & \textbf{Compound} & \textbf{Spreads} & \textbf{Vertices} & \textbf{File} \\
\midrule
5 & Truncated Tet & $(0, 0, 0.5)$ & 12 & \texttt{prime\_breakthrough*.json} \\
7 & Truncated Tet & $(0.11, 0, 0.5)$ & 12 & \texttt{prime\_breakthrough*.json} \\
11 & Trunc Tet + Icosa & $(0, 0.4, 0.2)$ & 24 & \texttt{prime\_breakthrough*.json} \\
13 & Trunc Tet + Icosa & $(0, 0.6, 0.8)$ & 24 & \texttt{prime\_breakthrough*.json} \\
\bottomrule
\end{tabular}
\caption{Verified prime projection configurations with source files}
\end{table}
...
\begin{itemize}[noitemsep]
    ...
    \item \textbf{v3.0 (Feb 2026): 11-gon and 13-gon breakthrough via compound polyhedra}
\end{itemize}
