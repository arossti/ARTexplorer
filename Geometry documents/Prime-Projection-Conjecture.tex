...
\subsection{ARTexplorer Visualization}

Integration with the ARTexplorer web application:
\begin{itemize}
    \item Load JSON results and visualize the polyhedron at the discovered angle
    \item Interactive exploration of nearby viewing angles
    \item Animate the transition from 3D view to 2D projection
\end{itemize}
