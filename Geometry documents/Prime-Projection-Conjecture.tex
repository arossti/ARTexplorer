...
\begin{enumerate}
    ...
    \item \textbf{7-hull projections exist}: At rational spread viewing angles $(0.11, 0, 0.5)$, the truncated tetrahedron projects to a 7-vertex convex hull boundary with 7 edges. Note: 2 of the 7 vertices are collinear (180° interior angles), so the visual silhouette is a 5-gon with 2 extra points on edges.
