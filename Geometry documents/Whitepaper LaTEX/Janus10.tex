...
\title{Geometric Janus Inversion -- v10 (Feb 2026)\\
...
These four programs---CPT-symmetric cosmology, black mirrors, Planck star bounces, and ER = EPR---were developed independently, using different formalisms (quantum field theory, loop quantum gravity, string theory), for different purposes (cosmological initial conditions, singularity resolution, information paradox). None reference tetrahedral coordinates or Quadray geometry.
...
Fuller spoke of the tetrahedron ``inside-outing'' through the origin. This language is evocative but topologically imprecise.
