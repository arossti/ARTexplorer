...
Each secondary strand is generated by:
...
4. The secondary strand follows the primary's path, offset by the face-bonding relationship

**Finding (Feb 1, 2026):** Visual inspection confirms 3 exposed faces per tetrahedron along the primary linear path, enabling the "3 around 1" configuration.
